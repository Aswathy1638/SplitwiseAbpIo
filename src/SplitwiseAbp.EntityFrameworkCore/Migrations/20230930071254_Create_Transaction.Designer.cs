...
namespace SplitwiseAbp.Migrations
{
    ...
    [Migration("20230930071254_Create_Transaction")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SplitwiseAbp.BalDetails.BalDetail", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("SplitwiseAbp.Groups.Group", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SplitwiseAbp.Participants.Participant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SplitwiseAbp.Transactions.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SplitwiseAbp.Transactions.Transaction", b =>
                {
                    b.HasOne("SplitwiseAbp.Expenses.Expense", "Expense")
                        .WithMany()
            ...
            modelBuilder.Entity("Volo.Abp.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasOne("SplitwiseAbp.Transactions.Transaction", null)
                        .WithMany("User")
